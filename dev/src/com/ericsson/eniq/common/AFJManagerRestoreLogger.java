...
public class AFJManagerRestoreLogger extends Handler {
	...
	private static final String SYBSYSTEMSTR = "afj_manager";
	...
	public AFJManagerRestoreLogger() throws IOException, SecurityException {	
		...
		logdir = plogdir + File.separator + SYBSYSTEMSTR;
		...
		final String systemDebugFlag = System.getProperty("AFJManagerLogger.debug");
	...
	private void rotate(final String dateStamp) {
		...
		try {
			...
			final File logFile = new File(dir, "restore_" + SYBSYSTEMSTR + "-" + dateStamp + ".log");
